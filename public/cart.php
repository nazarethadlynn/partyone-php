...
<!-- <button class="pay-btn" type="button">Proceed to Pay</button> -->
<button class="pay-btn" id="proceedPayBtn" type="button">
  Proceed to Pay
</button>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!payBtn) {
    console.error("Proceed to Pay button not found");
    return;
  }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  payBtn.addEventListener("click", function (e) {
    ...
    // Get amount to pay (NOT grand total)
    const amount = document.getElementById("amountToPay")?.innerText || "0";
